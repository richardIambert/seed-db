...
describe('data insertion', () => {
  test('topics data has been inserted correctly', () => {
    return query(`SELECT * FROM topics;`).then(({ rows: topics }) => {
  ...
  test('users data has been inserted correctly', () => {
    return query(`SELECT * FROM users;`).then(({ rows: users }) => {
  ...
  test('articles data has been inserted correctly', () => {
    return query(`SELECT * FROM articles;`).then(({ rows: articles }) => {
  ...
  test('comments data has been inserted correctly', () => {
    return query(`SELECT * FROM comments;`).then(({ rows: comments }) => {
